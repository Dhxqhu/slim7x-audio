...
Tracks used for testing are mostly classic soft rock tracks with lots of character like Steely Dan and different instrument and also high energy edm tracks to test the sound of overproduced tracks through the speakers.
